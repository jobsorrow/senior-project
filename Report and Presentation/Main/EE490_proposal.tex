    ...
    \noindent\resizebox{0.9\textwidth}{!}{
        \begin{tikzpicture}
            \begin{ganttchart}[
                ...
                \ganttbar[
                    bar/.append style={fill=black}
                ]{ศึกษาชุดเครื่องมือ Embedded Coder และสร้าง C Code จากแบบจำลอง และทวนสอบด้วยวิธี Software in the loop}{2021-11}{2021-12}\\
                \ganttbar[
                    bar/.append style={fill=black}
                ]{นำบอร์ด TI C2000 Launchpad มาผนวกรวมเข้ากับแบบจำลอง และทวนสอบด้วยวิธี Processor in the loop}{2022-01}{2022-02}\\
                \ganttbar[
                    bar/.append style={fill=black}
                ]{ศึกษา Hardware ที่เกี่ยวข้องเพื่อนำมา
                    ทดสอบใน Hardware ต่อไป
                }{2022-02}{2022-03}\\
                \ganttbar[
                    bar/.append style={fill=black}
                ]{วิเคราะห์และปรับปรุงส่วนต่าง ๆ
                    เพื่อให้ได้ประสิทธิภาพที่ดีขึ้น
                }{2022-03}{2022-04}\\
                \ganttbar[
                    bar/.append style={fill=black},
                    progress=100]{เขียนรายงาน}{2022-04}{2022-05}
            \end{ganttchart}
        \end{tikzpicture}
    }
    ...
    \noindent\resizebox{0.9\textwidth}{!}{
        \begin{tikzpicture}
            \begin{ganttchart}[
                ...
                \ganttbar[
                    bar/.append style={fill=black}
                ]{ศึกษาแผ่นพื้นเก็บพลังงานและสร้างแบบจำลองวงจรสมมูลไฟฟ้าที่รวมระบบทางกลของแผ่นพื้นเก็บพลังงานและเครื่องจักรไฟฟ้าซิงโครนัส }{2021-10}{2022-1}\\
                \ganttbar[
                    bar/.append style={fill=black}
                ]
                {วิเคราะห์และปรับปรุงส่วนต่างๆเพื่อให้ได้ประสิทธิภาพที่ดีขึ้น}{2022-01}{2022-04}\\
                \ganttbar[
                    bar/.append style={fill=black},
                    progress=100]
                {เขียนรายงาน}{2022-03}{2022-05}
            \end{ganttchart}
        \end{tikzpicture}
    }
