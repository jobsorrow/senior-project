 ...
 *
 * SIL generated interface for code: "control_algorithm"
 *
 */
...
/* interface data */
real_T i_LineCurrent[3];

/* interface data */
real_T i_BatteryVoltage;

/* interface data */
uint32_T o_CompareValue[3];

/* interface data */
real_T rtP_PWM_TIM_BASE_PRD;
...
/* interface data */
MdlrefDW_control_algorithm_T control_algorithm_MdlrefDW;

/* interface data */
RT_MODEL_control_algorithm_T tgt_var_RTModel;

/* interface (pointer) data */
RT_MODEL_control_algorithm_T * RTModel_ptr = &tgt_var_RTModel;
static XILIOData xil_fcnid0_task1_output_u[3];
static XILIOData xil_fcnid0_task1_y[3];
static XILIOData xil_fcnid0_init_y[2];
static XILIOData xil_fcnid0_ws_params[4];
static XILIOData xil_fcnid0_enable_y[2];
...
XIL_INTERFACE_ERROR_CODE xilInitialize(uint32_T xilFcnId)
{
  ...
  {
    {
      ...
      for (elementIdx_0 = 0; elementIdx_0 < 3; elementIdx_0++) {
        o_CompareValue[elementIdx_0] = 0;
        xilLinearIdx++;
      }                                /* for */
    }
  }
  ...
  if (xilFcnId == 0) {
    ...
    control_algorithm_initialize(rt_errorStatus, timingBridge, mdlref_TID0,
      RTModel_ptr, &(control_algorithm_MdlrefDW.rtb),
      &(control_algorithm_MdlrefDW.rtdw));
...
XIL_INTERFACE_ERROR_CODE xilSystemInitialize(uint32_T xilFcnId)
{
  ...
  /* Single In-the-Loop Component */
  if (xilFcnId == 0) {
    control_algorithm_Init(&(control_algorithm_MdlrefDW.rtb),
      &(control_algorithm_MdlrefDW.rtdw));
  } else {
    errorCode = XIL_INTERFACE_UNKNOWN_FCNID;
  }
   ...
   case XIL_OUTPUT_COMMAND:
    {
      ...
      if (!initComplete) {
        ...
        {
          void * dataAddress = (void *) &(i_LineCurrent[0]);
        ...
        {
          void * dataAddress = (void *) &(i_BatteryVoltage);
...
XIL_INTERFACE_ERROR_CODE xilOutput(uint32_T xilFcnId, uint32_T xilTID)
{
  ...
  switch (xilTID) {
   case 1:
    /* Call all Set class methods */
    control_algorithm(RTModel_ptr, i_LineCurrent, &(i_BatteryVoltage),
                      o_CompareValue, &(control_algorithm_MdlrefDW.rtb),
                      &(control_algorithm_MdlrefDW.rtdw));
   ...
   case XIL_INITIALIZE_COMMAND:
    {
      ...
      if (!initComplete) {
        ...
        {
          void * dataAddress = (void *) &(o_CompareValue[0]);
          xil_fcnid0_init_y[tableIdx].memUnitLength = 3 * sizeof(uint32_T);
   ...
   case XIL_OUTPUT_COMMAND:
    {
      ...
      if (!initComplete) {
        ...
        {
          void * dataAddress = (void *) &(o_CompareValue[0]);
          xil_fcnid0_task1_y[tableIdx].memUnitLength = 3 * sizeof(uint32_T);
...

        {
          ...
          void * dataAddress = (void*)
            (&control_algorithm_MdlrefDW.rtb.Zero_Sequence_Offset);
   ...
   case XIL_ENABLE_COMMAND:
    {
      ...
      if (!initComplete) {
        ...
        {
          void * dataAddress = (void *) &(o_CompareValue[0]);
          xil_fcnid0_enable_y[tableIdx].memUnitLength = 3 * sizeof(uint32_T);
          xil_fcnid0_enable_y[tableIdx++].address = (MemUnit_T *) dataAddress;
        }

        xil_fcnid0_enable_y[tableIdx].memUnitLength = 0;
        xil_fcnid0_enable_y[tableIdx++].address = (MemUnit_T *) 0;
        initComplete = 1;
      }                                /* if */
      ...
      *xilIOData = &xil_fcnid0_enable_y[0];
      break;
    }
   ...
   case XIL_SYSTEM_INITIALIZE_COMMAND:
    {
      ...
      if (!initComplete) {
        ...
        {
          void * dataAddress = (void *) &(o_CompareValue[0]);
          xil_fcnid0_system_initialize_y[tableIdx].memUnitLength = 3 * sizeof
            (uint32_T);
...
XIL_INTERFACE_ERROR_CODE xilEnable(uint32_T xilFcnId, uint32_T xilTID)
{
  ...
  switch (xilTID) {
   case 0:
    control_algorithm_Enable(&(control_algorithm_MdlrefDW.rtdw));
    break;
