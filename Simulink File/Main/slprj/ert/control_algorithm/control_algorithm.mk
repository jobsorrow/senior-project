...
## Generated on : Sun Oct 10 00:03:22 2021
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/slprj/ert/control_algorithm -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(START_DIR)/slprj/ert/_sharedutils -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021a/toolbox/target/SUPPOR~1/tic2000/inc -I$(MATLAB_ROOT)/toolbox/shared/can/src/scanutil -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021a/toolbox/target/SUPPOR~1/tic2000/src -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021a/toolbox/shared/SUPPOR~1/tic2000/src -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021a/toolbox/shared/SUPPOR~1/tic2000/inc -IC:/ti/c2000/C2000W~1/DEVICE~1/f28004x/common/include -IC:/ti/c2000/C2000W~1/LIBRAR~1/CALIBR~1/hrpwm/f28004x/include -IC:/ti/c2000/C2000W~1/DRIVER~1/f28004x/DRIVER~1 -IC:/ti/c2000/C2000W~1/DRIVER~1/f28004x/DRIVER~1/inc -IC:/ti/c2000/C2000W~1/DEVICE~1/f28004x/headers/include -IC:/ti/c2000/C2000W~1/DEVICE~1/f28004x/common -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021a/toolbox/target/shared/EXTERN~1/include -I$(MATLAB_ROOT)/toolbox/rtw/targets/common/can/blocks/tlc_c
...
DEFINES = $(DEFINES_BUILD_ARGS) $(DEFINES_CUSTOM) $(DEFINES_OPTS) $(DEFINES_SKIPFORSIL) $(DEFINES_STANDARD)

###########################################################################
## SOURCE FILES
###########################################################################

SRCS = $(START_DIR)/slprj/ert/control_algorithm/control_algorithm.c MW_c28xx_xbar.c MW_c28xx_board.c MW_c28xx_csl.c
...
OBJS = control_algorithm.obj MW_c28xx_xbar.obj MW_c28xx_board.obj MW_c28xx_csl.obj
...
%.obj : $(START_DIR)/slprj/ert/control_algorithm/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/slprj/ert/control_algorithm/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/slprj/ert/control_algorithm/%.asm
	$(AS) $(ASFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/slprj/ert/control_algorithm/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"
