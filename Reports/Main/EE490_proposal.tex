...
\begin{figure}[!h]
    ...
    \begin{circuitikz}[>=latex'][american]
        \tikzstyle{block} = [draw,rectangle,minimum height = 1.5cm]
    ...
    \begin{center}
        \begin{tikzpicture}
            ...
            \begin{axis}[
                ...
                % Plots
                \draw[fill=yellow,opacity=0.2] (axis cs:2,0) rectangle (axis cs:10,25);
                \node at (axis cs:6,22) {\small $Switching$ $Region$};
                \draw[fill=green,opacity=0.2] (axis cs:10,0) rectangle (axis cs:25,25);
                \node at (axis cs:18,22) {\small $Conduction$ $Region$};
                \addplot[color=red] coordinates {(0,20) (5,20) (10,1) (25,1)};
                \addplot[color=blue] coordinates {(0,0) (2,0) (8,15) (25,15)};
                \legend{$v_{sw}$,$i_{sw}$}
            \end{axis}
        \end{tikzpicture}
    \end{center}
...
\begin{figure}[!h]
    ...
    \begin{circuitikz}[american,scale=1.2,/tikz/circuitikz/tripoles/Lnigbt/height=0.8,/tikz/circuitikz/tripoles/Lnigbt/width=0/5]
        ...
        \draw[densely dotted] (0.0,0.5) to[R] (0.0,2.5);
        \draw[densely dotted] (0.0,-1.5) to[R] (0.0,0.5);
        ...
        \draw[densely dotted] (0.5,0.25) node[ground]{};
        \draw[densely dotted] (0.0,0.5) to[short] (0.5,0.5);
        \draw[densely dotted] (0.5,0.5) to[short] (0.5,-0.0);
    \end{circuitikz}
