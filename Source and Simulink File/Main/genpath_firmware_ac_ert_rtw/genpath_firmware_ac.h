...
#ifndef RTW_HEADER_genpath_firmware_ac_h_
#define RTW_HEADER_genpath_firmware_ac_h_
#ifndef genpath_firmware_ac_COMMON_INCLUDES_
#define genpath_firmware_ac_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "c2000BoardSupport.h"
#include "MW_f28004x_includes.h"
#include "DSP28xx_SciUtil.h"
#include "IQmathLib.h"
#endif                                /* genpath_firmware_ac_COMMON_INCLUDES_ */

#include "genpath_firmware_ac_types.h"
#include "rtGetInf.h"
...
} DW_genpath_firmware_ac_T;

/* Invariant block signals (default storage) */
typedef struct {
  const uint16_T Width;                /* '<S7>/Width' */
} ConstB_genpath_firmware_ac_T;
...
struct P_genpath_firmware_ac_T_ {
...
struct tag_RTM_genpath_firmware_ac_T {
...
extern P_genpath_firmware_ac_T genpath_firmware_ac_P;

/* Block signals (default storage) */
extern B_genpath_firmware_ac_T genpath_firmware_ac_B;

/* Block states (default storage) */
extern DW_genpath_firmware_ac_T genpath_firmware_ac_DW;
extern const ConstB_genpath_firmware_ac_T genpath_firmware_ac_ConstB;/* constant block i/o */

/* External function called from main */
extern void genpath_firmware_ac_SetEventsForThisBaseStep(boolean_T *eventFlags);

/* Model entry point functions */
extern void genpath_firmware_ac_SetEventsForThisBaseStep(boolean_T *eventFlags);
extern void genpath_firmware_ac_initialize(void);
extern void genpath_firmware_ac_step0(void);
extern void genpath_firmware_ac_step1(void);
extern void genpath_firmware_ac_terminate(void);
extern volatile boolean_T runModel;

/* Real-time Model object */
extern RT_MODEL_genpath_firmware_ac_T *const genpath_firmware_ac_M;
 ...
 * Block '<S42>/Add1' : Unused code path elimination
 * Block '<S42>/Data Type Duplicate' : Unused code path elimination
 * Block '<S42>/Filter_Constant' : Unused code path elimination
 * Block '<S42>/One' : Unused code path elimination
 * Block '<S42>/Product' : Unused code path elimination
 * Block '<S42>/Product1' : Unused code path elimination
 * Block '<S42>/Unit Delay' : Unused code path elimination
 ...
 *
 * '<Root>' : 'genpath_firmware_ac'
 * '<S1>'   : 'genpath_firmware_ac/ADC Interrupt Callback'
 * '<S2>'   : 'genpath_firmware_ac/SCI Receive Interrupt Callback'
 * '<S3>'   : 'genpath_firmware_ac/ADC Interrupt Callback/ADC'
 * '<S4>'   : 'genpath_firmware_ac/ADC Interrupt Callback/Command Data Parser'
 * '<S5>'   : 'genpath_firmware_ac/ADC Interrupt Callback/Inverter Driver'
 * '<S6>'   : 'genpath_firmware_ac/ADC Interrupt Callback/MPPT Algorithm'
 * '<S7>'   : 'genpath_firmware_ac/ADC Interrupt Callback/Packet Serializer'
 * '<S8>'   : 'genpath_firmware_ac/ADC Interrupt Callback/Serial Transmit'
 * '<S9>'   : 'genpath_firmware_ac/ADC Interrupt Callback/Timer'
 * '<S10>'  : 'genpath_firmware_ac/ADC Interrupt Callback/ADC/DC Bus Voltage IIR Filter'
 * '<S11>'  : 'genpath_firmware_ac/ADC Interrupt Callback/ADC/Phase Current ADC'
 * '<S12>'  : 'genpath_firmware_ac/ADC Interrupt Callback/ADC/Phase Current IIR Filter'
 * '<S13>'  : 'genpath_firmware_ac/ADC Interrupt Callback/ADC/Phase Voltage ADC'
 * '<S14>'  : 'genpath_firmware_ac/ADC Interrupt Callback/ADC/Phase Voltage IIR Filter'
 * '<S15>'  : 'genpath_firmware_ac/ADC Interrupt Callback/ADC/DC Bus Voltage IIR Filter/IIR Filter'
 * '<S16>'  : 'genpath_firmware_ac/ADC Interrupt Callback/ADC/DC Bus Voltage IIR Filter/IIR Filter/Low-pass'
 * '<S17>'  : 'genpath_firmware_ac/ADC Interrupt Callback/ADC/DC Bus Voltage IIR Filter/IIR Filter/Low-pass/IIR Low Pass Filter'
 * '<S18>'  : 'genpath_firmware_ac/ADC Interrupt Callback/ADC/Phase Current IIR Filter/IIR Filter'
 * '<S19>'  : 'genpath_firmware_ac/ADC Interrupt Callback/ADC/Phase Current IIR Filter/IIR Filter/Low-pass'
 * '<S20>'  : 'genpath_firmware_ac/ADC Interrupt Callback/ADC/Phase Current IIR Filter/IIR Filter/Low-pass/IIR Low Pass Filter'
 * '<S21>'  : 'genpath_firmware_ac/ADC Interrupt Callback/ADC/Phase Voltage IIR Filter/IIR Filter'
 * '<S22>'  : 'genpath_firmware_ac/ADC Interrupt Callback/ADC/Phase Voltage IIR Filter/IIR Filter/Low-pass'
 * '<S23>'  : 'genpath_firmware_ac/ADC Interrupt Callback/ADC/Phase Voltage IIR Filter/IIR Filter/Low-pass/IIR Low Pass Filter'
 * '<S24>'  : 'genpath_firmware_ac/ADC Interrupt Callback/Inverter Driver/PWM Gain and Offset'
 * '<S25>'  : 'genpath_firmware_ac/ADC Interrupt Callback/Inverter Driver/Two Arm Modulation and First Quadrant Tracking Algorithm'
 * '<S26>'  : 'genpath_firmware_ac/ADC Interrupt Callback/Inverter Driver/Two Arm Modulation and First Quadrant Tracking Algorithm/First Quadrant Tracking Algorithm'
 * '<S27>'  : 'genpath_firmware_ac/ADC Interrupt Callback/Inverter Driver/Two Arm Modulation and First Quadrant Tracking Algorithm/Two Arm Modulation Algorithm'
 * '<S28>'  : 'genpath_firmware_ac/ADC Interrupt Callback/Inverter Driver/Two Arm Modulation and First Quadrant Tracking Algorithm/First Quadrant Tracking Algorithm/Load Balancing'
 * '<S29>'  : 'genpath_firmware_ac/ADC Interrupt Callback/Inverter Driver/Two Arm Modulation and First Quadrant Tracking Algorithm/First Quadrant Tracking Algorithm/Lower Always On'
 * '<S30>'  : 'genpath_firmware_ac/ADC Interrupt Callback/Inverter Driver/Two Arm Modulation and First Quadrant Tracking Algorithm/First Quadrant Tracking Algorithm/Upper Always On'
 * '<S31>'  : 'genpath_firmware_ac/ADC Interrupt Callback/Inverter Driver/Two Arm Modulation and First Quadrant Tracking Algorithm/First Quadrant Tracking Algorithm/Load Balancing/Counter Limited'
 * '<S32>'  : 'genpath_firmware_ac/ADC Interrupt Callback/Inverter Driver/Two Arm Modulation and First Quadrant Tracking Algorithm/First Quadrant Tracking Algorithm/Load Balancing/Counter Limited/Increment Real World'
 * '<S33>'  : 'genpath_firmware_ac/ADC Interrupt Callback/Inverter Driver/Two Arm Modulation and First Quadrant Tracking Algorithm/First Quadrant Tracking Algorithm/Load Balancing/Counter Limited/Wrap To Zero'
 * '<S34>'  : 'genpath_firmware_ac/ADC Interrupt Callback/Inverter Driver/Two Arm Modulation and First Quadrant Tracking Algorithm/Two Arm Modulation Algorithm/Compute Two Arm Modulation Offset'
 * '<S35>'  : 'genpath_firmware_ac/ADC Interrupt Callback/Inverter Driver/Two Arm Modulation and First Quadrant Tracking Algorithm/Two Arm Modulation Algorithm/Zero Offset'
 * '<S36>'  : 'genpath_firmware_ac/ADC Interrupt Callback/Inverter Driver/Two Arm Modulation and First Quadrant Tracking Algorithm/Two Arm Modulation Algorithm/Compute Two Arm Modulation Offset/If Lower Switch Always Conduct'
 * '<S37>'  : 'genpath_firmware_ac/ADC Interrupt Callback/Inverter Driver/Two Arm Modulation and First Quadrant Tracking Algorithm/Two Arm Modulation Algorithm/Compute Two Arm Modulation Offset/If Upper Switch Always Conduct'
 * '<S38>'  : 'genpath_firmware_ac/ADC Interrupt Callback/MPPT Algorithm/Derivative'
 * '<S39>'  : 'genpath_firmware_ac/ADC Interrupt Callback/MPPT Algorithm/IIR Filter'
 * '<S40>'  : 'genpath_firmware_ac/ADC Interrupt Callback/MPPT Algorithm/IIR Filter/IIR Filter'
 * '<S41>'  : 'genpath_firmware_ac/ADC Interrupt Callback/MPPT Algorithm/IIR Filter/IIR Filter/Low-pass'
 * '<S42>'  : 'genpath_firmware_ac/ADC Interrupt Callback/MPPT Algorithm/IIR Filter/IIR Filter/Low-pass/IIR Low Pass Filter'
 * '<S43>'  : 'genpath_firmware_ac/ADC Interrupt Callback/Packet Serializer/Avoid Header and Terminator Collision'
 * '<S44>'  : 'genpath_firmware_ac/ADC Interrupt Callback/Packet Serializer/Counter Limited'
 * '<S45>'  : 'genpath_firmware_ac/ADC Interrupt Callback/Packet Serializer/Data'
 * '<S46>'  : 'genpath_firmware_ac/ADC Interrupt Callback/Packet Serializer/Start'
 * '<S47>'  : 'genpath_firmware_ac/ADC Interrupt Callback/Packet Serializer/Avoid Header and Terminator Collision/If Action Subsystem'
 * '<S48>'  : 'genpath_firmware_ac/ADC Interrupt Callback/Packet Serializer/Avoid Header and Terminator Collision/If Action Subsystem1'
 * '<S49>'  : 'genpath_firmware_ac/ADC Interrupt Callback/Packet Serializer/Avoid Header and Terminator Collision/If Action Subsystem2'
 * '<S50>'  : 'genpath_firmware_ac/ADC Interrupt Callback/Packet Serializer/Counter Limited/Increment Real World'
 * '<S51>'  : 'genpath_firmware_ac/ADC Interrupt Callback/Packet Serializer/Counter Limited/Wrap To Zero'
 */
#endif                                 /* RTW_HEADER_genpath_firmware_ac_h_ */
