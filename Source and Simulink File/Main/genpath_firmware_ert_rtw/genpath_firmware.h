 ...
 * '<S35>'  : 'genpath_firmware/ADC Interrupt Callback/Inverter Driver/Two Arm Modulation Algorithm'
 * '<S36>'  : 'genpath_firmware/ADC Interrupt Callback/Inverter Driver/Two Arm Modulation Algorithm/Compute Two Arm Modulation Offset'
 * '<S37>'  : 'genpath_firmware/ADC Interrupt Callback/Inverter Driver/Two Arm Modulation Algorithm/Counter Limited'
 * '<S38>'  : 'genpath_firmware/ADC Interrupt Callback/Inverter Driver/Two Arm Modulation Algorithm/Zero Offset'
 * '<S39>'  : 'genpath_firmware/ADC Interrupt Callback/Inverter Driver/Two Arm Modulation Algorithm/Compute Two Arm Modulation Offset/If Lower Switch Always Conduct'
 * '<S40>'  : 'genpath_firmware/ADC Interrupt Callback/Inverter Driver/Two Arm Modulation Algorithm/Compute Two Arm Modulation Offset/If Upper Switch Always Conduct'
 * '<S41>'  : 'genpath_firmware/ADC Interrupt Callback/Inverter Driver/Two Arm Modulation Algorithm/Counter Limited/Increment Real World'
 * '<S42>'  : 'genpath_firmware/ADC Interrupt Callback/Inverter Driver/Two Arm Modulation Algorithm/Counter Limited/Wrap To Zero'
 */
